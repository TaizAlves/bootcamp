...
const { update, findOne } = require('../models/Order')
...
module.exports= {
    ...
    async post(req,res){
        ...
        try{
        //pegar os productos do carrinho
    ...
    async update(req, res) {
        try{
            ...
            const accepetedActions = ['close', 'cancel']
            if(!accepetedActions.includes(action)) return res.send("Can´t do this action")
