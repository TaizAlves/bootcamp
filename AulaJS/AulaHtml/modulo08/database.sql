...
-- apagar a tabela "base" gravada no db
...
-- cancelamento em cascata em users e products
...
-- SOFT DELETE
--1. Criar uma columna na table products chamada "deleted_at"
ALTER TABLE products ADD COLUMN "deleted_at" timestamp;

--2. Criar uma Regra que vai rodar todas as vexes que solicitarmos o DELETE
...
--3. Criar uma VIEW onde vamos puxar somente os dados ativos
